...
formatter_list = [
    ...
    CustomFormatter("BACKTICKS", lambda text: f"`{text}`"),
    CustomFormatter("MARKDOWN_LINK", lambda text: f"[{text}]()"),
    ...
    CodeFormatter("DOT_STAR_SEPARATED", ".*", lower, lower),
    ...
    CodeFormatter("SPACE_SEPARATED", " ", lower, lower),
]
