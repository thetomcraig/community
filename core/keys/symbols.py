...
old_symbols = [
    ...
    Symbol(" ", ["void"]),
    Symbol("(", ["paren", "L paren", "left paren", "left round"]),
    ...
    Symbol("{", None, ["brace", "L brace", "left brace", "curly bracket", "left curly bracket", "laser", "lacer"]),
